...
Section un.UnregisterFileExt
	; Remove references to "Mikepad++_file"
...
Enum_HKCR_Loop:
	...
	${If} $0 == "Mikepad++_file"
		ReadRegStr $3 HKCR $2 "Mikepad++_backup"
		...
		${Else}
			...
			DeleteRegValue HKCR $2 "Mikepad++_backup"
			IntOp $1 $1 + 1
		${EndIf}
	${Else}
		IntOp $1 $1 + 1
...
Enum_HKCR_Done:
	...
	; Remove references to "Mikepad++_file" from "Open with..."
	IntOp $1 0 + 0	; subkey index
	StrCpy $2 ""	; subkey name
Enum_FileExts_Loop:
	EnumRegKey $2 HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts" $1
	StrCmp $2 "" Enum_FileExts_Done
	DeleteRegValue HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\$2\OpenWithProgids" "Mikepad++_file"
	IntOp $1 $1 + 1
	Goto Enum_FileExts_Loop
Enum_FileExts_Done:

	; Remove "Mikepad++_file" file type
	DeleteRegKey HKCR "Mikepad++_file"
SectionEnd
...
!endif
	...
	;DeleteRegKey HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\mikepad++.exe"
!ifdef ARCH64
	SetRegView 64
!else ifdef ARCHARM64
	SetRegView 64
...
!macro uninstallDir dir2remove
	; Delete Shortcuts
	Delete "$SMPROGRAMS\Mikepad++\Uninstall.lnk"
	RMDir "$SMPROGRAMS\Mikepad++"
	...
	Delete "$SMPROGRAMS\Mikepad++\Mikepad++.lnk"
	Delete "$SMPROGRAMS\Mikepad++\readme.lnk"
