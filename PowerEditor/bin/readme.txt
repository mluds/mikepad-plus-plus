...
Mikepad++ is a free (as in "free speech" and also as in "free beer") source code editor and Notepad replacement (https://npp-user-manual.org/docs/other-resources/#notepad-replacement) that supports several programming languages and natural languages. Running in the MS Windows environment, its use is governed by GPL (GNU General Public License).
...
From the zip/7z package:
	Unzip all the files into a directory you want then launch "mikepad++.exe".

	
Web sites:
***********

Mikepad++ official site:
	https://notepad-plus-plus.org/

Mikepad++ project site:
