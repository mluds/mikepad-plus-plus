...
// You should implement (or define an empty function body) those functions which are called by Mikepad++ plugin manager
...
// This API return always true now, since Mikepad++ isn't compiled in ANSI mode anymore
