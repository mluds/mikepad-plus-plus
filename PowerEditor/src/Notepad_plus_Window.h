...
-x : Move Mikepad++ to indicated left side position on the screen\r\
-y : Move Mikepad++ to indicated top position on the screen\r\
-nosession : Launch Mikepad++ without previous session\r\
-notabbar : Launch Mikepad++ without tabbar\r\
-ro : Make the filePath read only\r\
-systemtray : Launch Mikepad++ directly in system tray\r\
-loadingTime : Display Mikepad++ loading time\r\
-alwaysOnTop : Make Mikepad++ always on top\r\
...
-quickPrint : Print the file given as argument then quit Mikepad++\r\
...
-titleAdd=\"string\": add string to Mikepad++ title bar\r\
...
public:
	...
	static HWND gNppHWND;	//static handle to Mikepad++ window, NULL if non-existant
