...
private:
	...
	generic_string _xmlDirPath; // The 1st place to load function list files. Usually it's "%APPDATA%\Mikepad++\functionList\"
	generic_string _xmlDirInstalledPath; // Where Mikepad++ is installed. The 2nd place to load function list files. Usually it's "%PROGRAMFILES%\Mikepad++\functionList\" 
